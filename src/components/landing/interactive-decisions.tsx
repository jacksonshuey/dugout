...
const DECISIONS: Decision[] = [
  ...
  },
  {
    ...
    triggeringSignal: "Procurement freeze cited twice → KKR",
    ...
    feedback:
      "Engagement signal +0.4 on acc_kkr. CHAMPION_GHOST rule suppressed for 7 days; PROCUREMENT_FREEZE_CITED moves to monitor.",
    decidedBy: "Sara Chen (AE)",
    age: "1d ago",
  },
  {
  ...
  },
  {
    ...
    triggeringSignal: "Boeing 8-K · DoD contract award disclosed",
