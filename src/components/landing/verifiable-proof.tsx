...
const STATS: Stat[] = [
  {
    value: "268",
    label: "vitest cases",
    body: "Across 15 test files. CI gates every PR on green. The signal engine, SV Health Score, inbound pipeline, ranker, and integration health are all covered.",
    evidence: {
  ...
  },
  {
    ...
    body: "Cross-source correlation only works if every adapter's output joins on the same key. Source-specific signals across the stack collapse into 12 canonical types. The signalType IS the contract.",
    evidence: {
      label: "types.ts",
      href: `${GITHUB_BASE}/src/lib/types.ts`,
    },
  },
  {
    value: "3",
