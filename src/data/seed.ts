...
export const contacts: Contact[] = [
  ...
  // KKR (Sara) — Selected Vendor: champion + GC + Finance, but no Procurement
  ...
  // CNA (Sara) — Selected Vendor stalled: Finance engaged, IT brief never sent
  ...
  // Snowflake (Marcus) — Selected Vendor, healthy
...
export const activities: Activity[] = [
  ...
  // KKR — active Finance conversation but procurement not introduced
  ...
  // CNA — IT brief never sent, deal stalled
  ...
  // Snowflake — multithreaded, healthy
